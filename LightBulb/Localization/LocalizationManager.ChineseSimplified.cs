...
public partial class LocalizationManager
{
    private static readonly IReadOnlyDictionary<string, string> ChineseSimplifiedLocalization =
        new Dictionary<string, string>
        {
            ...
            // Preset modes (预设模式)
            [nameof(PresetModesLabel)] = "预设模式",
            [nameof(PresetAutoName)] = "自动",
            [nameof(PresetAutoTooltip)] = "跟随日出日落自动调节",
            [nameof(PresetReadingName)] = "阅读",
            [nameof(PresetOfficeName)] = "办公",
            [nameof(PresetNightName)] = "夜间",
            [nameof(PresetMovieName)] = "影视",
            [nameof(PresetCodeName)] = "编程",
            [nameof(PresetGameName)] = "游戏",
            [nameof(PresetEyeCareName)] = "护眼",
            [nameof(PresetCustomName)] = "自定义",

            // Break reminder (休息提醒)
            [nameof(BreakTitle)] = "该休息一下了",
            [nameof(BreakMessage)] = "抬头看看 20 英尺（约 6 米）以外的东西，让眼睛放松一会儿。",
            [nameof(BreakSkipButton)] = "跳过这次",
            [nameof(BreakPostponeButton)] = "5 分钟后再提醒",
            [nameof(BreakReminderLabel)] = "休息提醒",
            [nameof(BreakReminderTooltip)] = "连续工作一段时间后，用全屏提示提醒你休息",
            [nameof(BreakWorkDurationLabel)] = "工作时长：",
            [nameof(BreakWorkDurationTooltip)] = "连续工作多久后提醒休息",
            [nameof(BreakDurationLabel)] = "休息时长：",
            [nameof(BreakDurationTooltip)] = "提醒持续多长时间",
            [nameof(TrayTakeBreakMenuItem)] = "立即休息",
            ...
            [nameof(TrayShowMenuItem)] = "显示",
            [nameof(TrayHideMenuItem)] = "隐藏",
            [nameof(TraySettingsMenuItem)] = "设置",
            [nameof(TrayEnableMenuItem)] = "启用",
            [nameof(TrayDisableMenuItem)] = "禁用",
            [nameof(TrayDisableTemporarilyMenuItem)] = "禁用...",
